...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['actualite', 'evenement', 'communique', 'autre']
    > &
...
export interface ApiDirectorDirector extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nomComplet: Schema.Attribute.String;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audience: Schema.Attribute.Enumeration<
      ['\u00C9tudiants', 'Enseignants', 'Administrateurs', 'Chercheurs', 'Tous']
    >;
    category: Schema.Attribute.Enumeration<
      ['loi', 'decret', 'arrete', 'circulaire', 'rapport', 'guide']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<
      ['technique', 'financier', 'academique', 'institutionnel']
    > &
      Schema.Attribute.DefaultTo<'technique'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    website: Schema.Attribute.String;
...
export interface ApiSubscriberSubscriber extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    confirmationTokenExpires: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email &
    ...
    unsubscribeTokenExpires: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
