...
export default function EditService() {
      ...
      await execute(async () => {
        ...
        if (data) {
          setFormData({
            ...
            category: data.category || 'etudiants',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await execute(async () => {
        await secureApi.put(`/api/admin/services/${id}`, serviceData, true);
  ...
  return (
    <>
      <Head>
        <title>Modifier le Service - Administration MESRIT</title>
        <meta name="description" content="Modifier un service existant" />
      </Head>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-niger-orange focus:ring-4 focus:ring-niger-orange/20 dark:border-secondary-600"
